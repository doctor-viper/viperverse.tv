<?php require_once($_SERVER['DOCUMENT_ROOT'].'/inc/header.php'); ?>
  ...
  <div class="box">
    ...
    <div class="sunfirstlayer"></div>
    <div class="sunsecondlayer"></div>
    <div class="sunthirdlayer"></div>
    <div class="sunfourthlayer"></div>
    <div class="sunfifthlayer"></div>
    <div class="sunsixthlayer"></div>
    <div class="sunseventhlayer"></div>
    <div class="suneighthlayer"></div>
    <div class="sunninthlayer"></div>
  </div>
